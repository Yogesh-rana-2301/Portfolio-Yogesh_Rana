...
export function TableOfContents({
  ...
  const handleNextSection = () => {
    if (hasViewedAllSections) {
      // Redirect to GitHub
      window.open("https://github.com/yogesh-rana-2301", "_blank");
      return;
    }
  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="hidden md:block fixed top-1/2 right-4 transform -translate-y-1/2 z-50 mb-8"
      >
        <div className="relative h-auto ">
          ...
          {/* Progress bar */}
          <motion.div
            className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-red-100 to-red-300 rounded-full origin-top"
            style={{
          ...
          {/* Section markers */}
          <ul className="relative flex flex-col items-center h-full space-y-4">
